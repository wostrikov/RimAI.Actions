...
public class SlaughterHandler : IActionHandler
{
	public string ActionId => "slaughter";
	...
	public ExecutionResult Execute(ExecutionContext context)
	{
		...
		if (pawn != null)
		{
			...
			if (raceProps != null && raceProps.Animal)
			{
				...
				Verse.AI.Job job = JobMaker.MakeJob(JobDefOf.Slaughter, pawn);
				context.StartOrQueueJob(job);
				EALogger.Debug(resolvedActor.Name.ToStringShort + " slaughtering " + pawn.LabelCap);
