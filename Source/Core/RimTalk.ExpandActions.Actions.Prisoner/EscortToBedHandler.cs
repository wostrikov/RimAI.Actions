...
public class EscortToBedHandler : IActionHandler
{
	public string ActionId => "escort_to_bed";
	...
	public ExecutionResult Execute(ExecutionContext context)
	{
		...
		Verse.AI.Job job = JobMaker.MakeJob(JobDefOf.EscortPrisonerToBed, pawn);
		context.StartOrQueueJob(job);
		EALogger.Debug(resolvedActor.Name.ToStringShort + " escorting " + pawn.Name.ToStringShort + " to bed");
