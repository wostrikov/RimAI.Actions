...
public class ReleasePrisonerHandler : IActionHandler
{
	public string ActionId => "release_prisoner";
	...
	public ExecutionResult Execute(ExecutionContext context)
	{
		...
		Verse.AI.Job job = JobMaker.MakeJob(JobDefOf.ReleasePrisoner, pawn);
		context.StartOrQueueJob(job);
		EALogger.Debug(resolvedActor.Name.ToStringShort + " releasing " + pawn.Name.ToStringShort);
